...
public class Relic{
  private String type; //can be "s"-start combat,"e"-end combat,"p"-permanent,"iS"-iterative start turn,"iE"-iterative End turn
  private String name;
   ...
   * @param iterations
   */
  public Relic(String type,String name, String description, Card cardEffect, int energyEffect,int healthEffect,  int iterations ){
    this.type = type;
    this.name = name;
